...
import { TrendingUp, Users, DollarSign, Target, Calendar, MessageCircle } from "lucide-react";
...
const leadSourceData = [
  ...
  { name: 'Cold Calls', value: 20, color: '#ef4444' },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-orange-600">12</span> overdue
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm">New lead from Sarah Johnson</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm">Follow-up scheduled with TechCorp</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm">Proposal sent to ABC Industries</p>
            ...
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
              <div>
                <p className="text-sm">Deal closed with MegaCorp - $45K</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm">147 / 200</span>
              </div>
