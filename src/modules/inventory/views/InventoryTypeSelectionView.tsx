      ...
      <div className="inventory-entry-container max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent tracking-tight mb-2">Add New Inventory</h2>
              <p className="text-lg text-gray-600 leading-relaxed">Select the inventory entry type to proceed</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-blue-700">
              <div className="w-20 h-20 rounded-full flex items-center justify-center text-3xl font-bold mb-2 shadow-lg border-2 border-white bg-gradient-to-r from-blue-500 to-blue-600 text-white ring-2 ring-blue-300">1</div>
            ...
            <div className="flex flex-col items-center text-gray-700">
              <div className="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-2 shadow-lg border-2 border-white bg-gradient-to-r from-gray-300 to-gray-400 text-gray-800">2</div>
              <span className="text-sm font-medium text-center leading-tight text-gray-500">Costing Option</span>
            </div>
            <div className="flex-1 h-1 mx-4 rounded-full bg-gray-300" />
            <div className="flex flex-col items-center text-gray-700">
              <div className="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-2 shadow-lg border-2 border-white bg-gradient-to-r from-gray-300 to-gray-400 text-gray-800">3</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <button onClick={() => selectTypeAndContinue('in-stock')}
              className={`p-6 border-2 rounded-lg transition-colors text-left ${selectedType === 'in-stock' ? 'border-green-500 bg-green-50 ring-2 ring-green-200' : 'border-gray-200 hover:border-green-500 hover:bg-green-50'}`}>
              <div className="flex items-center mb-3"><Package className="w-8 h-8 text-green-600 mr-3" /><h4 className="text-lg font-medium text-gray-900">In-Stock / Received</h4></div>
            ...
            <button onClick={() => selectTypeAndContinue('on-order')}
              className={`p-6 border-2 rounded-lg transition-colors text-left ${selectedType === 'on-order' ? 'border-orange-500 bg-orange-50 ring-2 ring-orange-200' : 'border-gray-200 hover:border-orange-500 hover:bg-orange-50'}`}>
              <div className="flex items-center mb-3"><Truck className="w-8 h-8 text-orange-600 mr-3" /><h4 className="text-lg font-medium text-gray-900">On-Order / Pending</h4></div>
          ...
          <div className="mt-8 flex justify-end">
            <button onClick={handleContinue} disabled={!canContinue}
              className={`px-8 py-4 rounded-lg font-medium text-lg shadow-lg flex items-center gap-2 transition-colors ${canContinue ? 'bg-[#4f46e5] text-white hover:bg-[#4338ca]' : 'bg-gray-300 text-gray-500 cursor-not-allowed'}`}>
              Continue
