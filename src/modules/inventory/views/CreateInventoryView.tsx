...
/**
 * CreateInventoryView - Dumb component for multi-step inventory creation
 */
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              validation.fieldErrors?.category ? 'border-red-500' : 'border-gray-300'
            }`}
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              validation.fieldErrors?.costPrice ? 'border-red-500' : 'border-gray-300'
            }`}
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              validation.fieldErrors?.sellPrice ? 'border-red-500' : 'border-gray-300'
            }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setField('warrantyYears', Number(e.target.value))}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="border-t border-gray-200 pt-6">
        ...
        {validation.fieldErrors?.serialNumbers && (
          <p className="text-red-500 text-sm mb-4">{validation.fieldErrors.serialNumbers}</p>
        )}
          ...
          <div className="bg-gray-50 rounded-lg p-4 max-h-48 overflow-y-auto">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-gray-700">
                {formData.serialNumbers.length} serial(s) added
              </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setField('paymentAmount', Number(e.target.value))}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        {formData.paymentMethod === 'Bank' && (
          <div>
            ...
            >
              ...
              {/* Banks would be populated from context */}
            </select>
          </div>
        )}
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-4 mt-6">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="font-medium">{formData.brandName} {formData.modelName}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium">
              {InventoryService.formatCurrency((formData.costPrice || 0) * (formData.stock || 0))}
            </p>
          </div>
        </div>
      </div>
  ...
  const renderConfirmationStep = () => (
    <div className="text-center py-8">
      ...
      <p className="text-gray-600 mb-6">
        Please review the information and click Create to add the product to inventory.
      </p>
      ...
      <div className="bg-gray-50 rounded-lg p-6 max-w-md mx-auto text-left">
        <div className="space-y-3 text-sm">
          <div className="flex justify-between">
            <span className="text-gray-500">Product:</span>
            <span className="font-medium">{formData.brandName} {formData.modelName}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">Category:</span>
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">{InventoryService.formatCurrency(formData.costPrice || 0)}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">Sell Price:</span>
            <span className="font-medium">{InventoryService.formatCurrency(formData.sellPrice || 0)}</span>
          </div>
          <div className="flex justify-between">
