      ...
      <div className="inventory-entry-container max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">Create a new product entry with optional costing information</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between max-w-4xl mx-auto">
            ...
            <div className="flex-1 h-1 mx-4 rounded-full bg-gradient-to-r from-green-500 to-blue-500" />
            <div className="flex flex-col items-center text-blue-700">
              <div className="w-20 h-20 rounded-full flex items-center justify-center text-3xl font-bold mb-2 shadow-lg border-2 border-white bg-gradient-to-r from-blue-500 to-blue-600 text-white ring-2 ring-blue-300">2</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <button onClick={() => selectOption('with')}
              className={`p-6 border-2 rounded-lg transition-colors text-left ${selectedOption === 'with' ? 'border-purple-500 bg-purple-50 ring-2 ring-purple-200' : 'border-gray-200 hover:border-purple-500 hover:bg-purple-50'}`}>
              <div className="flex items-center mb-3"><Calculator className="w-8 h-8 text-purple-600 mr-3" /><h4 className="text-lg font-medium text-gray-900">With Costing</h4></div>
            ...
            <button onClick={() => selectOption('without')}
              className={`p-6 border-2 rounded-lg transition-colors text-left ${selectedOption === 'without' ? 'border-orange-500 bg-orange-50 ring-2 ring-orange-200' : 'border-gray-200 hover:border-orange-500 hover:bg-orange-50'}`}>
              <div className="flex items-center mb-3"><Package className="w-8 h-8 text-orange-600 mr-3" /><h4 className="text-lg font-medium text-gray-900">Without Costing</h4></div>
