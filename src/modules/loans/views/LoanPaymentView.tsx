...
import { ArrowLeft, CreditCard, CheckCircle, AlertCircle, Wallet, Landmark, Calendar, User, Building2 } from 'lucide-react';
...
/** AED prefix for amount input fields */
const AEDPrefix: React.FC = () => (
...
export const LoanPaymentView: React.FC<LoanPaymentViewProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="p-6 flex justify-center py-8">
    ...
    return (
      <div className="p-6">
        <div className="border border-red-200 bg-red-50 rounded-lg p-6">
          ...
          <button
            onClick={onCancel}
            className="mt-4 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2"
          >
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="flex items-center gap-3">
            {/* AED label replaces DollarSign icon */}
            <span className="h-5 w-5 text-xs font-bold text-gray-400 flex items-center justify-center">AED</span>
            <div>
              <p className="text-sm text-gray-500">Total Amount</p>
              <p className="font-medium text-gray-900">{formatCurrency(loan.loanAmount)}</p>
            </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Payment Details (AED)</h3>
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-14 pr-3 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4f46e5]"
              />
            </div>
              ...
              {(['Cash', 'Bank'] as ('Cash' | 'Bank')[]).map(m => (
                <label
                  ...
                  className={`flex items-center gap-2 p-4 border-2 rounded-lg cursor-pointer transition-all flex-1 ${
                    formData.mode === m ? 'border-[#4f46e5] bg-indigo-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
                >
                  <input
                    type="radio"
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      {m === 'Cash' ? 'Pay with physical cash' : 'Pay from bank account'}
                    </div>
                  </div>
                </label>
              ))}
