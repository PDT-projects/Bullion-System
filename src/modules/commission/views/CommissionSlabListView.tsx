...
import { Plus, Search, Edit, Trash2, Filter, SlidersHorizontal } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage commission percentage slabs for salespeople</p>
        </div>
        <button
          onClick={onAdd}
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200">
          ...
          <div className="text-2xl font-bold text-gray-900">{Object.values(filter).filter(Boolean).length}</div>
        </div>
        <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-2">
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-[100px]">Actions</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredSlabs.map((slab) => (
                    <tr key={slab.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900">{slab.commissionPercentage}%</td>
                      <td className="px-6 py-4 text-sm text-gray-900">
