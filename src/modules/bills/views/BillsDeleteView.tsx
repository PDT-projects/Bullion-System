          ...
          <div className="flex items-center gap-4 bg-red-50 p-4 rounded-lg border border-red-200">
            ...
            <div>
              ...
              <p className="text-sm text-red-600">
                Deleting this bill will permanently remove it from the system. If this was a bank payment, the amount will be refunded to the bank account.
              </p>
            </div>
          </div>
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium text-gray-900">{bill.transactionId}</p>
              </div>
              <div>
