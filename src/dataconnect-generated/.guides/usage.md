...
```ts
import { useListEmployees, useGetEmployeeById, useEmployeeInsert, useEmployeeUpdate, useEmployeeDelete } from '@erp-system/dataconnect/react';
...
```js
import { listEmployees, getEmployeeById, employeeInsert, employeeUpdate, employeeDelete } from '@erp-system/dataconnect';
