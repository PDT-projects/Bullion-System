...
**If you're looking for the `JavaScript README`, you can find it at [`employees/README.md`](../README.md)**

***NOTE:** This README is generated alongside the generated SDK. If you make changes to this file, they will be overwritten when the SDK is regenerated.*

You can use this generated SDK by importing from the package `@erp-system/employees/react` as shown below. Both CommonJS and ESM imports are supported.
...
## ListEmployees
You can execute the `ListEmployees` Query using the following Query hook function, which is defined in [employees/react/index.d.ts](./index.d.ts):
...
To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `ListEmployees` Query is of type `ListEmployeesData`, which is defined in [employees/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, ListEmployeesVariables } from '@erp-system/employees';
import { useListEmployees } from '@erp-system/employees/react'
...
## GetEmployeeById
You can execute the `GetEmployeeById` Query using the following Query hook function, which is defined in [employees/react/index.d.ts](./index.d.ts):
...
To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `GetEmployeeById` Query is of type `GetEmployeeByIdData`, which is defined in [employees/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, GetEmployeeByIdVariables } from '@erp-system/employees';
import { useGetEmployeeById } from '@erp-system/employees/react'
...
## employeeInsert
You can execute the `employeeInsert` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [employees/react/index.d.ts](./index.d.ts)):
```javascript
...
To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `employeeInsert` Mutation is of type `EmployeeInsertData`, which is defined in [employees/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, EmployeeInsertVariables } from '@erp-system/employees';
import { useEmployeeInsert } from '@erp-system/employees/react'
...
## employeeUpdate
You can execute the `employeeUpdate` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [employees/react/index.d.ts](./index.d.ts)):
```javascript
...
To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `employeeUpdate` Mutation is of type `EmployeeUpdateData`, which is defined in [employees/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, EmployeeUpdateVariables } from '@erp-system/employees';
import { useEmployeeUpdate } from '@erp-system/employees/react'
...
## employeeDelete
You can execute the `employeeDelete` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [employees/react/index.d.ts](./index.d.ts)):
```javascript
...
To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `employeeDelete` Mutation is of type `EmployeeDeleteData`, which is defined in [employees/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, EmployeeDeleteVariables } from '@erp-system/employees';
import { useEmployeeDelete } from '@erp-system/employees/react'
