...
export function useListReceivableProducts(vars?: ListReceivableProductsVariables, options?: useDataConnectQueryOptions<ListReceivableProductsData>): UseDataConnectQueryResult<ListReceivableProductsData, ListReceivableProductsVariables>;
export function useListReceivableProducts(dc: DataConnect, vars?: ListReceivableProductsVariables, options?: useDataConnectQueryOptions<ListReceivableProductsData>): UseDataConnectQueryResult<ListReceivableProductsData, ListReceivableProductsVariables>;

export function useGetReceivableProduct(vars: GetReceivableProductVariables, options?: useDataConnectQueryOptions<GetReceivableProductData>): UseDataConnectQueryResult<GetReceivableProductData, GetReceivableProductVariables>;
export function useGetReceivableProduct(dc: DataConnect, vars: GetReceivableProductVariables, options?: useDataConnectQueryOptions<GetReceivableProductData>): UseDataConnectQueryResult<GetReceivableProductData, GetReceivableProductVariables>;
