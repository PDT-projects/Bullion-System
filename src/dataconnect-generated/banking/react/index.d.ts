...
export function useBankUpdate(options?: useDataConnectMutationOptions<BankUpdateData, FirebaseError, BankUpdateVariables>): UseDataConnectMutationResult<BankUpdateData, BankUpdateVariables>;
export function useBankUpdate(dc: DataConnect, options?: useDataConnectMutationOptions<BankUpdateData, FirebaseError, BankUpdateVariables>): UseDataConnectMutationResult<BankUpdateData, BankUpdateVariables>;

export function useBankDelete(options?: useDataConnectMutationOptions<BankDeleteData, FirebaseError, BankDeleteVariables>): UseDataConnectMutationResult<BankDeleteData, BankDeleteVariables>;
export function useBankDelete(dc: DataConnect, options?: useDataConnectMutationOptions<BankDeleteData, FirebaseError, BankDeleteVariables>): UseDataConnectMutationResult<BankDeleteData, BankDeleteVariables>;

export function useUpdateBankBalance(options?: useDataConnectMutationOptions<UpdateBankBalanceData, FirebaseError, UpdateBankBalanceVariables>): UseDataConnectMutationResult<UpdateBankBalanceData, UpdateBankBalanceVariables>;
export function useUpdateBankBalance(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateBankBalanceData, FirebaseError, UpdateBankBalanceVariables>): UseDataConnectMutationResult<UpdateBankBalanceData, UpdateBankBalanceVariables>;
...
export function useCashInHandInsert(options?: useDataConnectMutationOptions<CashInHandInsertData, FirebaseError, CashInHandInsertVariables>): UseDataConnectMutationResult<CashInHandInsertData, CashInHandInsertVariables>;
export function useCashInHandInsert(dc: DataConnect, options?: useDataConnectMutationOptions<CashInHandInsertData, FirebaseError, CashInHandInsertVariables>): UseDataConnectMutationResult<CashInHandInsertData, CashInHandInsertVariables>;

export function useCashInHandDelete(options?: useDataConnectMutationOptions<CashInHandDeleteData, FirebaseError, CashInHandDeleteVariables>): UseDataConnectMutationResult<CashInHandDeleteData, CashInHandDeleteVariables>;
export function useCashInHandDelete(dc: DataConnect, options?: useDataConnectMutationOptions<CashInHandDeleteData, FirebaseError, CashInHandDeleteVariables>): UseDataConnectMutationResult<CashInHandDeleteData, CashInHandDeleteVariables>;
